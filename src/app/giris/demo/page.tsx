...
import { DEMO_CONSULTANT, listDemoMembers } from "@/data/session";
import { SCOPE_LABEL } from "@/data/types";
import { selectDemoMember } from "../actions";

export const metadata: Metadata = {
  title: "Örnek panel",
  description: "Hipokampüs örnek paneline göz atın.",
};
  ...
  return (
    <span
      ...
      className={`flex size-14 shrink-0 items-center justify-center rounded-full font-[family-name:var(--font-display)] text-xl text-white shadow-[var(--shadow-soft)] ${
        muted ? "bg-ink-300" : "bg-linear-to-br from-teal-600 to-teal-800"
      }`}
    >
      {initials}
    </span>
...
export default async function DemoGirisSayfasi() {
    ...
    <div className="bg-paper">
      <div className="relative isolate overflow-hidden bg-sky-50 py-16 sm:pt-20 sm:pb-12">
        ...
        <Container className="relative">
          ...
          >
            Hesap açmadan, {consultant.name} ailesinin örnek kaydı üzerinden
            paneli hemen inceleyebilirsiniz.
          </p>
        </Container>
      </div>
      ...
      <Container className="py-10 sm:py-12">
        <div className="hk-enter mb-8" style={{ animationDelay: "160ms" }}>
          <DemoNotice>
            Bu bölümde parola sorulmuyor ve hiçbir kişisel veri toplanmıyor.
